...
class TestApiFucntions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        setattr(self.db_mock, 'db', self.doc)
        setattr(self.request, 'registry', self.db_mock)
    ...
    def test_contract_from_data_415_error(self, mocker_error_handler):
        mocker_error_handler.side_effect = error_handler
        setattr(self.request.registry, 'contract_contractTypes',
                {'common': None})
    ...
    def test_save_contract_return_None(self, mocker_get_revision_changes,
        ...
        setattr(self.contract_mock, 'mode', u'test')
    ...
    def test_save_contract_return_True(self, mocker_get_revision_changes):
        ...
        setattr(self.request, 'authenticated_userid', 'Quinta')
        setattr(self.contract_mock, 'rev', self.contract_id)
        setattr(self.contract_mock, 'mode', u'prod')
